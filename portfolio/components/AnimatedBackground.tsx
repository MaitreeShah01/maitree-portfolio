...
export default function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      draw() {
        ...
        ctx.fillStyle = "rgba(147, 197, 253, 0.4)"; // Soft blue
        ctx.fill();
      }
    }
    ...
    const initParticles = () => {
      particles =[];
      const particleCount = window.innerWidth < 768 ? 35 : 80; // Cap on mobile
      ...
      for (let i = 0; i < particles.length; i++) {
        ...
        for (let j = i; j < particles.length; j++) {
          ...
          if (distance < 130) {
            ...
            ctx.strokeStyle = `rgba(147, 197, 253, ${0.15 - distance / 860})`;
            ctx.lineWidth = 0.8;
  ...
  return (
    <div className="fixed inset-0 z-[-1] pointer-events-none bg-slate-950 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-black">
